    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/SJ.jpg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>Serviços Juridicos</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>É o profissional trabalha em locais como escritórios de advocacia, prefeituras, cartórios, tribunais de justiça e fóruns</b></p>
                        </div>

                        <div class="Botao_imagem">
                            <button type="button" class="btn btn-danger"><b>CONHEÇA A NOSSA HISTÓRIA</b></button>
                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra um futuro brilhante em </br>Serviços Jurídicos</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>Os serviços jurídicos são essenciais para o funcionamento de uma sociedade justa e organizada. Advogados, 
                                juízes, promotores e outros profissionais do direito desempenham um papel fundamental na resolução de conflitos,
                                na aplicação das leis e na garantia dos direitos e deveres de todos os cidadãos. Por trás desses profissionais,
                                no entanto, há uma figura que desempenha um papel crucial na gestão e no suporte dessas operações – o gestor de 
                                serviços jurídicos e notariais.</p>

                            </div>

                            <div class="Botao_Conteudo1">
                                <button type="button" class="btn btn-danger"><b>CONHEÇA NOSSA INFRAESTRUTURA</b></button>
                            </div>
