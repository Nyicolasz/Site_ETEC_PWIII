    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/todomundo.jpeg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>DESENVOLVIMENTO DE SISTEMAS</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>Curso legalzinho, só não faça</b></p>
                        </div>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra se presta ou não o </br>DS</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>Você vai sofrer de uma forma nunca sofrida antes em sua vida. è um caminho sem volta, você vai se sentir o mais 
                                    esperto no começo, mas depois você vai ver que é burro, burro, burro. Depois da sua primeira nota vermemlha, 
                                    vocÊ entende que nada tem sentido. No terceiro ano nota que nada nem ninguém se importa com você :)</p>
