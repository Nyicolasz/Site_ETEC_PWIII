    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="https://www.eteczonaleste.com.br/wp-content/uploads/2023/11/tyler-franta-iusJ25iYu1c-unsplash-scaled.jpg" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>ADMINISTRAÇÃO</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>O profissional desempenha um papel crucial no planejamento, organização e gerenciamento de uma empresa.</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA O CURSO</b></a></button>                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo1">
                    <h2><b>Sobre</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>O curso de Administração abrange disciplinas gerais nos primeiros anos, como Fundamentos de Administração, 
                                    Contabilidade, Marketing e Psicologia. Posteriormente, os estudantes se aprofundam em matérias específicas,
                                    como Comportamento Organizacional, Economia de Empresas, Finanças Corporativas, Estrutura Organizacional, 
                                    Gestão de Pessoas, Inovação e Empreendedorismo.</p>

                            </div>

                            <div class="Botao_Conteudo1">
                                <button type="button" class="btn btn-danger"><b>CONVEERSA COM NOIX AI</b></button>
                            </div>
                            ...
                            <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('img/Adm_marda.jpg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Adm_patinho.png')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Adm3.png')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="bg-body-tertiary " id="Conteudo2">
                ...
                <div class="container text-center" id="Titulo2">
            ...
            </div> <div class="container text-center" id="Titulo">
                    <h2><b>Nossos Cursos</b></h2>
                </div>
                ...
                <div class="container text-center" id="Cartoes_Cursos">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="card" id="Cartao_DS" onclick="Cartao_JS()">
                                <img src="img/Juridico.jpg" class="card-img-top" alt="..." id="img_Cartao">
                                <div class="card-body">
                                    <h5 class="card-title">Serviços Jurídicos</h5>
                                    <div id="traco"></div>
