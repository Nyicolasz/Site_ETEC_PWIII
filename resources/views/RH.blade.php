    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/RH3.jpg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>Recursos Humanos</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>É o profisional que não conseguiu passa em DS e foi ler curriculo</b></p>
                        </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>Só faz RH, quem em DS, não consegiu passar. Vou pra RH, já que não gosto de estudar</p>
