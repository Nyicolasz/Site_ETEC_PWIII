    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Concurso.webp')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>VESTIBULINHO</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>O Vestibulhinho das Escolas Técnicas Estaduais Ocorrem de Forma Semestral, Dess forma você tem mais chance de fazer dessa elite.</b></p>
                        </div>

                        <div class="Botao_imagem">
                            <button type="button" class="btn btn-danger" onclick="window.open('https://www.vestibulinhoetec.com.br/home/', '_blank')"><b>INSCREVA-SE</b></button>
                        </div>
                    </div>
                </figure>
