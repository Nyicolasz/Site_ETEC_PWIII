    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Marcelo.jpeg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>Marcelo Collado</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>Vão dizer que é puxar saco, mas Marcelo, essa é para você. Não podia faltar o cara que me vê mais que minha propria familia</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA O MARCELO</b></a></button>
                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra quem é o melhor coordenador da</br>ETEC ZONA LESTE</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>Marcelo Collado. O que dizer desse homem. Muitos momentos sentimos um pouco de raiva, como por exemplo na prova de
                                QTS, mas em todos os momentos sempre mostra ser um companheiro. Homem de grande lutas (literalmente, o cara é faixa marrom) e vem fazendo o seu melhor cada dia.
                                Sei que não é facil, muitas coisas ao mesmo tempo, mas lembre-se sempre do bom cara que você é. 
                            </p>

                            </div>

                            <div class="Botao_Conteudo1">
                                <button type="button" class="btn btn-danger" onclick="window.open('https://www.instagram.com/marcelo.collado66?igsh=NHBvMWVqbWw0aWN0', '_blank')"><b>CONHEÇA O COLLADO MARCELO</b></button>
                            </div>
                            ...
                            <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('img/Marcelo_todomundo.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Marcelo_atual.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Marcelo_Cafe.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/So_Home.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Marcelo_antiga.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Marcelo_Lindao.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                </div>
                            </div>
