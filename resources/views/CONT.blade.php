    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Cont2.jpg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>Contabilidade</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b> O profissional especializado em serviços contábeis, registra, analisa e interpreta as transações financeiras de uma empresa</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA O CURSO</b></a></button>
                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra um futuro na contabilidade pela </br>ETEC ZONA LESTE</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>São responsáveis por preparar e apresentar declarações fiscais, calcular impostos devidos e fornecer assessoria fiscal aos clientes. Os contadores
                                desempenham um papel crucial na elaboração de demonstrações financeiras, como o balanço patrimonial, a 
                                demonstração de resultados e a demonstração dos fluxos de caixa.</p>
