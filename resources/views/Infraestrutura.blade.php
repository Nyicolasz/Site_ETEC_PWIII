    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Sala_Maker.jpeg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>INFRAESTRUTURA</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>Conheça a Infraestrutura da Etec Zona Leste: Excelência em Educação Técnica na Região da Zona Leste de São Paulo</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA A INFRAESTRUTURA</b></a></button>
                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra a infraestrutura da </br>ETEC ZONA LESTE</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p>Toma cuidado ao abrir as cortinas (principalmente se você for o Julio) Os notebooks foram bons durante um tempo, mas sei lá, eu só reclamo também</p>

                            </div>

                            <div class="Botao_Conteudo1">
                            <button type="button" class="btn btn-danger"><a class="nav-link" href="/Historia"><b>CONHEÇA NOSSA HISTORIA</b></a></button>
                            </div>
