    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Direcao.jpeg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>DIREÇAO</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>A Direção Escolar é o departamento executivo encarregado da organizar as atividades administrativas e pedagógicas da Etec.</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA A DIREÇÃO</b></a></button>                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra mais sobre a direção da</br>ETEC ZONA LESTE</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p> 1 - Garantir as condições para o desenvolvimento da gestão democrática do ensino, na forma prevista pela legislação e neste Regimento;
                                    </br> 2 – promover a elaboração do projeto político-pedagógico da escola;
                                    </br>3 – coordenar a elaboração, o acompanhamento, a avaliação e o controle da execução do Plano Plurianual de Gestão;
                                </p>

                            </div>

                            <div class="Botao_Conteudo1">
                            <button type="button" class="btn btn-danger"><a class="nav-link" href="Infraestrutura"><b>CONHEÇA NOSSA INFRAESTRUTURA</b></a></button>                            </div>
                            ...
                            <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('img/Fercadim.jpeg')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/figurinhas.png')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
