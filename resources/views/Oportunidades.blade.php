    ...
    <div>
        ...
        <main>
            <div id="Figure_Visao_Geral">
                ...
                <figure class="figure">
                    <img src="{{asset('img/Oportunidades3.jpg')}}" id="Visao_Geral">

                    <div id="Textos_Imagem">
                        <div id="Texto1_imagem">
                            <p class="h6"><b>OPORTUNIDADES</b></p>
                        </div>

                        <div id="Texto2_imagem">
                            <p class="h2"><b>Com a ETEC da Zona Leste, portas, no mercado de trabalho, lhe serão. Encontre sua trajetória de sucesso!</b></p>
                        </div>

                        <div class="Botao_imagem">
                        <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo1"><b>CONHEÇA AS OPORTUNIDADES</b></a></button>                        </div>
                    </div>
                </figure>
            ...
            <div id="Conteudo1">
                ...
                <div class="container text-center" id="Titulo">
                    <h2><b>Descubra as oportnidades da</br>ETEC ZONA LESTE</b></h2>
                </div>
                    ...
                    <div class="row" id="Linha_Carrosel">
                        <div class=" col">
                            ...
                            <div id="Texto1" class="container text-center">
                                ...
                                <p> 1 - Estão em andamento concursos públicos para contratação de 2,7 mil docentes e servidores administrativos para atuar em Escolas Técnicas
                                    </br> 2 – Processo Seletivo Simplificado para Auxiliar de Docente
                                    </br>3 – Programa Aprendiz Paulista
                                </p>

                            </div>

                            <div class="Botao_Conteudo1">
                            <button type="button" class="btn btn-danger"><a class="nav-link" href="#Conteudo2"><b>CONHEÇA OS CURSOS</b></a></button>                            </div>
                            ...
                            <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('img/Concurso.webp')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Processo.webp')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{asset('img/Aprendiz.webp')}}" class="d-block w-100" alt="..." id="Imagem1carr">
                                    </div>
                                </div>
                            </div>
